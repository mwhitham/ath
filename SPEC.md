# The Athletic Standard Format — Specification v0.4.1
...
```json
{
  "athleticstandard_version": "0.4.1",
  "athlete": { },
  "sources": [ ],
  "hard_signals": [ ],
  "soft_signals": [ ],
...
```json
{ "athleticstandard_version": "0.4.1", "quantity": "heart_rate", "unit": "bpm",
...
```json
{ "athleticstandard_version": "0.4.1", "quantity": "steps", "unit": "count",
