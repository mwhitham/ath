/**
 * ath — the Athletic Standard command tree.
 *
 ...
 *
 * `cli.ts` parses this. `scripts/generate-skill-cli.ts` reads its help, so the
 * skill's command reference is built from the same source as `--help` (D80).
 */
